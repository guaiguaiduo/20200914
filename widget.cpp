...
void saleall(pigcircle pc[])
{
    ...
    destFile<<"sale"<<endl<<"当前日期为： "<<ddays<<endl<<"销售数目为： "<<saleamount<<endl<<"销售总额为： "<<sumprice<<endl;
    destFile.close();
}
    ...
    ui(new Ui::Widget)
{
    ...
    ui->b1->show();ui->pp->hide();ui->cd->show();ui->b3->hide();ui->return_2->hide();
            ...
            [=]()
    {
        ...
        ui->b1->hide();ui->pp->show();ui->cd->show();ui->b3->show();ui->return_2->hide();
    });
            ...
            [=]()
    {
        ...
        ui->sure->hide();ui->textBrowser->hide();ui->textBrowser_2->hide();ui->textBrowser_3->hide();
        ui->b1->hide();ui->pp->hide();ui->cd->hide();ui->b3->hide();ui->return_2->show();
    });
            ...
            [=]()
{
        ...
        ui->bs->hide();ui->buy->hide();ui->ing->hide();ui->pushButton->hide();ui->bb->hide();
        ui->sure->hide();ui->textBrowser->show();ui->textBrowser_2->show();ui->textBrowser_3->show();
        ui->b1->hide();ui->pp->hide();ui->cd->show();ui->b3->hide();ui->return_2->hide();
    });
            ...
            [=]()
    {
        ...
        ui->sure->show();ui->textBrowser->show();ui->textBrowser_2->show();ui->textBrowser_3->show();
        ui->b1->hide();ui->pp->show();ui->cd->show();ui->b3->hide();ui->return_2->hide();
    });
